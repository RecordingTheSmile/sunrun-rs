use sea_orm::{ActiveModelTrait, ColumnTrait, Condition, EntityTrait, FromQueryResult, PaginatorTrait, QueryFilter, QuerySelect, Set};
...
impl UserManager {
    pub async fn create_user<ToStr>(username: ToStr, password: ToStr, email: ToStr) -> BusinessResult<i64>
    ...
    pub async fn ensure_can_login<ToStr>(username: ToStr, password: ToStr) -> BusinessResult<i64>
        where ToStr: ToString
    {
